...
Payment Redirect Main flow Recurring Payment
    [Setup]       Run Keywords                        Set Test Variable    ${EXCEL_NAME}    ${EXCEL_2C2P_PAYMENT}
    ...           AND                                 Set Test Variable    ${SHEET_NAME}    ${SHEET_Redirect}
    [Teardown]    Close Browser
    [Template]    API_Validation_Payment_Recurring
   #             #rowNo                              statusCode           testcaseNo       cardtype
    22            200                                 RDR1005_001          visa 
    23            200                                 RDR1005_002          visa 

Payment Redirect Main flow Installment Payment
    [Setup]       Run Keywords                          Set Test Variable    ${EXCEL_NAME}    ${EXCEL_2C2P_PAYMENT}
    ...           AND                                   Set Test Variable    ${SHEET_NAME}    ${SHEET_Redirect}
    [Teardown]    Close Browser
    [Template]    API_Validation_Payment_Installment
   #             #rowNo                                statusCode           testcaseNo       cardtype
    24            200                                   RDR1006_001          visa 
    25            200                                   RDR1006_002          visa 